...
import type { Swap as SwapType } from '@/lib/supabase';
import { GSEED_TO_PYUSD_RATE } from '@/lib/wallet-utils';
...
export function SwapInterface({ swap, onSwapSuccess }: SwapInterfaceProps) {
  ...
  const setMaxAmount = () => {
    setGseedAmount(swap.gseed_amount.toString());
  };
